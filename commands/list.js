...
module.exports.run = async (client, message, args) => {
  ...
  const msg = await message.reply({ embeds: [new Discord.MessageEmbed().setDescription("Choose an option in the select menu to get started!").setColor("#5964f4").setTimestamp()], components: [row] })
