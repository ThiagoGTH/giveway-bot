...
module.exports = {
  ...
  const msg = await interaction.channel.send({ embeds: [new Discord.MessageEmbed().setDescription("Choose an option in the select menu to get started!").setColor("#5964f4").setTimestamp()], components: [row] })
